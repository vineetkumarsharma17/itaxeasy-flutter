                ...
                child: Column(
                  ...
                  children: [
                    ...
                    FadeInRight(
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Please Fill Pan Number"),));
                      }if(panCont.text.length<10 ||panCont.text.length > 10){
                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("PAN Number Should be 10 Digits"),));
                              ...
                              if (result.resposeCode ==200) {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                                  content: Text("Something Went Wrong, Check Your Details"),));
                              }
                            }
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(apiResponse.data.company.pan,
                                      ...
                                      const SizedBox(height: 5,),
                                      Text(apiResponse.data.company.fullName,
                                        style: const TextStyle(
                                          fontFamily: "Poppins",
                                          fontWeight: FontWeight.w500,
                                          letterSpacing: 1.5,
                                      ...
                                      const SizedBox(height: 5,),
                                      Text(apiResponse.data.company.status,
                                        style: const TextStyle(
                                          fontFamily: "Poppins",
                                          fontWeight: FontWeight.w500,
                                          letterSpacing: 1.5,
                                      ...
                                      const SizedBox(height: 10,),
                                      const Text("Aadhaar Seeding Status ",
                                        style: TextStyle(
                                          fontFamily: "Poppins",
                                          fontWeight: FontWeight.bold,
                                          letterSpacing: 1.5,
                                      ...
                                      const SizedBox(height: 5,),
                                      Text(apiResponse.data.company.aadhaarSeedingStatus,
                                        style: const TextStyle(
                                          fontFamily: "Poppins",
                                          fontWeight: FontWeight.w500,
                                          letterSpacing: 1.5,
                                      ...
                                      const SizedBox(height: 5,),
                                      Text(apiResponse.data.company.category,
                                        style: const TextStyle(
                                          fontFamily: "Poppins",
                                          fontWeight: FontWeight.w500,
                                          letterSpacing: 1.5,
                                      ...
                                      const SizedBox(height: 5,),
                                      Text(apiResponse.data.company.lastUpdated,
                                        style: const TextStyle(
                                          fontFamily: "Poppins",
                                          fontWeight: FontWeight.w500,
                                          letterSpacing: 1.5,
