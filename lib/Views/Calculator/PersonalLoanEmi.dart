                        ...
                        onPressed: () async {
                          ...
                          if(loanAmount.text.isEmpty || rate.text.isEmpty || loanTenure.text.isEmpty ){
                            ...
                            insert = PersonalLoan(
                                ...
                                loanTenure: double.parse(loanTenure.text)

                            );
                            _apiResponse = await apiServices.personalLoanEmi(insert);


                            if(_apiResponse.resposeCode == 200){
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>PersonalLoanResponseUi(apiResponse:_apiResponse ,)));
