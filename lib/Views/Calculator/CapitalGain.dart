                        ...
                        child: Padding(
                          ...
                          child: DropdownButtonHideUnderline(
                            child: DropdownButton<String>(
                              ...
                              items: <String>['equityMutualFunds','stocks', 'mutualFunds', 'bonds', 'gold', 'property']
                  ...
                  child: Container(
                    ...
                    child: GFButton(
                        ...
                        onPressed: () async {
                          ...
                          if(buyPrice.text.isEmpty || sellPrice.text.isEmpty || buyDate == null || sellDate == null ){
                            ...
                            _apiResponse = await apiServices.capitalGain(insert);
                            if(_apiResponse.resposeCode == 200){
                              if(_apiResponse.data.message == null){
                                ...
                                ScaffoldMessenger.of(context).showSnackBar( SnackBar(content: Text(_apiResponse.data.message),));
                              }
                              print("------------------SUCCESS-----------------");
                            }else{
                        ...
                        return Card(
                          ...
                          child:  Column(
                              ...
                              children:[
                                ...
                                Text(_apiResponse.data.profit.toString()??""),
                                ...
                                Text(_apiResponse.data.effectiveTaxRate??""),
