                  ...
                  child: Container(
                    ...
                    child: GFButton(
                        ...
                        onPressed: () async {
                          ...
                          if(totalInvestment.text.isEmpty || matuarityValue.text.isEmpty || years.text.isEmpty ){
                         ...
                         final   insert = Cagr(
                                totalInvestment: int.parse(totalInvestment.text),
                                matuarityValue: int.parse(matuarityValue.text),
                        ...
                        child: Card(
                          child: Padding(
                            ...
                            child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children:[
                                  const Text("Compound annual growth rate",
                                    style: TextStyle(
                                      fontFamily: "Poppins",
                                  ...
                                  Text(_apiResponse.data.cagr.toString(),style: TextStyle(
                                    fontSize: 25
                                  ),),
                                ]
                            ),
          ...
          return  pw.Center(
            child:           pw.Column(
                ...
                children:[
                  ...
                  pw. Text("Compound Annual Growth Rate",
                    style: pw.TextStyle(
                      // fontFamily: "Poppins",
                  ...
                  pw. Text(_apiResponse.data.cagr.toString(), style: pw.TextStyle(
                    // fontFamily: "Poppins",
                    // fontWeight:pw.FontWeight.bold,
                    fontSize: 22.5,
                  ),),
