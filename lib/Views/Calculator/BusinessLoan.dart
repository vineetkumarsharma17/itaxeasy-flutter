                    ...
                    child: GFButton(
                        ...
                        onPressed: () async {
                          ...
                          if(loanAmount.text.isEmpty || rate.text.isEmpty || loanTenure.text.isEmpty){
                            ...
                            _apiResponse = await apiServices.businessLoan(insert);
                            if(_apiResponse.resposeCode == 200){
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>BusinessResponseUi(apiResponse: _apiResponse,)));
                              print("------------------SUCCESS-----------------");
                            }else{
