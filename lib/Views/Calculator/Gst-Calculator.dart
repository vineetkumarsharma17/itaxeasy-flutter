                        ...
                        child: Container(
                          ...
                          child: GFButton(
                              ...
                              onPressed: () async {
                                ...
                                if(amount.text.isEmpty || gstRate.text.isEmpty ){
                                  ...
                                  _apiResponse = await apiServices.gstCal(insert);


                                  if(_apiResponse.resposeCode == 200){
                                       setState(() {
                                         cgst =  double.parse(_apiResponse.data.gstAmount) / 2;
                                         isVisible = true;
                                       });
                                    print("------------------SUCCESS-----------------");
                                  }else{
                          ...
                          return Padding(
                            ...
                            child: Column(
                                ...
                                children:[
                                  ...
                                  Text(_apiResponse.data.gstType.toString()),
                                  const SizedBox(
                                    height: 5,
                                  ),
                                  const Text("GST Rate",
                                  ...
                                  Text(_apiResponse.data.gstRate.toString()),
                                  const SizedBox(
                                    height: 5,
                                  ),
                                  const Text("Amount",
                                  ...
                                  Text(_apiResponse.data.amount.toString()),
                                  const SizedBox(
                                    height: 5,
                                  ),
                                  ...
                                  Text(_apiResponse.data.finalAmount.toString()),
                                  //
                                  // const SizedBox(
                                  //   height: 5,
                                  // ),
