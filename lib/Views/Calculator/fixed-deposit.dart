                ...
                FadeInRight(
                  ...
                  child: Container(
                    ...
                    child: GFButton(
                        ...
                        if(type.text.isEmpty || principle.text.isEmpty || rate.text.isEmpty || year.text.isEmpty || compound.text.isEmpty  ){
                          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Please Fill The Given Field"),));
                            ...
                            final insert = FixedDeposit(
                                ...
                                compoundFreqInYear: int.parse(compound.text)
                            );
                            _apiResponse = await apiServices.fixedDeposit(insert);


                            if(_apiResponse.resposeCode == 200){
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>FixedDepositResponseUi(apiResponse: _apiResponse ,)));
