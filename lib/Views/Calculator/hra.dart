                ...
                Form(
                  child: Column(
                    children: [
                      ...
                      CheckboxListTile(
                        title: const Text("Metro City",style: TextStyle(
                          fontFamily: "Poppins",
                          fontWeight: FontWeight.w500,
                          letterSpacing: 1.5,
                          fontSize: 17.5,
                  ...
                  child: Container(
                    ...
                    child: GFButton(
                        ...
                        onPressed: () async {
                          ...
                          if(basic.text.isEmpty || hra.text.isEmpty || rentPaid.text.isEmpty || allowances.text.isEmpty){
                          ...
                          child: Padding(
                            ...
                            child: Column(
                                ...
                                children:[
                                  ...
                                  Text(_apiResponse.data.hraExempted.toString()),
                                ]
                            ),
                          ),
                        );
