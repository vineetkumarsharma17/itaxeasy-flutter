...
class _FileUploadState extends State<FileUpload> with SingleTickerProviderStateMixin {
  ...
  performImageLabling()async{
    final  FirebaseVisionImage firebaseVisionImage = FirebaseVisionImage.fromFile(_file);
  ...
  selectFile() async {
    final file = await FilePicker.platform.pickFiles(type: FileType.custom, allowedExtensions: ['png', 'jpg', 'jpeg']);
