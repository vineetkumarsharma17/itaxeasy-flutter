                    ...
                    child: Container(
                      ...
                      child: GFButton(
                        ...
                        onPressed: () async {
                          ...
                          if(gstinCont.text.isEmpty ){
                          ...
                          }if(gstinCont.text.length<15 ||gstinCont.text.length > 15){
                            ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("GSTIN Number Should be 15 Digits"),));
                          }else{
                            setState(() {
                              isLoading = true;
                            });
                            final insert = gstinCont.text;
                            final result = await apiServices.searchGstNumber(insert);
                            setState(() {
                              isLoading = false;
                            });
                            if (result.resposeCode == 200) {
                              ...
                              final message = await storage.read(key: "taxByGSTIN");
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      apiResponse.data.results.data.tradeNam,
                                      style: const TextStyle(
                                        fontFamily: "Poppins",
                                        fontWeight: FontWeight.w500,
                                        letterSpacing: 1.5,
                                    ...
                                    const Text(
                                     ...
                                     Text(apiResponse.data.results.data.nba.toString(),
                                      style: TextStyle(
                                        fontFamily: "Poppins",
                                        fontWeight: FontWeight.w500,
                                        letterSpacing: 1.5,
                                    ...
                                    Wrap(
                                        children: [
                                      Text(
                                        apiResponse.data.results.data.pradr.addr
                                            .bno +
                                            apiResponse.data.results.data.pradr
                                                .addr.flno
                                                .toString() +
                                            apiResponse.data.results.data.pradr
                                                .addr.bnm +
