          ...
          child: Padding(
            ...
            child: Column(
              children: [
                    ...
                    child: Card(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            Center(
                              child: Image.asset("assets/images/coupon.png",width: 100,height:100),
                            ),
                            const SizedBox(
                              height: 10,
                            ),
                            Text("Sale:Click to Scan your docx by OCR",
                        ...
                        child: Card(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                Center(
                                  child: Image.asset("assets/icons/saless.png",width: 50,height:50),
                                ),
                                const SizedBox(
                                  height: 20,
                                ),
                        ...
                        child: Card(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                Center(
                                  child: Image.asset("assets/icons/salesreturn.png",width: 50,height:50),
                                ),
                                const SizedBox(
                                  height: 10,
                                ),
                      ...
                      child: Card(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              Center(
                                child: Image.asset("assets/icons/credit.png",width: 50,height:50),
                              ),
                              const SizedBox(
                                height: 10,
                              ),
                ...
                Text("Total Sale :",         style: GoogleFonts.recursive(
