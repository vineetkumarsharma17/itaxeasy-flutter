                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      fontSize: 17.5,
                        ...
                        Text("When filing a cybercrime complaint, please ensure the following relevant information is captured and reflected in the FIR/criminal complaint in relation to the account misuse:",
                          style :TextStyle(
                        ...
                        Text("a: Complete details of the complainant, such as PAN, Aadhaar Number etc. and brief of the alleged incident",
                          style :TextStyle(
                            fontFamily: "Poppins",
                            fontWeight: FontWeight.w500,
                            letterSpacing: 1.5,
                        ...
                        Text("c: The date and approximate time when the account misuse came to your attention, and how it came to your attention;",
                          style :TextStyle(
                            fontFamily: "Poppins",
                            fontWeight: FontWeight.w500,
                            letterSpacing: 1.5,
                        ...
                        Text("d: Any information, facts or details relevant to the suspected account misuse.",
                          style :TextStyle(
                            fontFamily: "Poppins",
                            fontWeight: FontWeight.w500,
                            letterSpacing: 1.5,
