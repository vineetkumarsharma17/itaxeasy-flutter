            ...
            onPressed: ()async {
                if(pinCount.text.isEmpty && cityName.text.isEmpty){
                  ...
                  ScaffoldMessenger.of(context)
                    ...
                    content:
                    Text("Please enter the PIN Code OR CityName"),
                  ));
                  ...
                  if(pinCount.text.isNotEmpty){
                    ...
                    apiResponse = await  apiServices.pinCodeInfo(pinCount.text);
                    setState(() {
                      isLoading = false;
                    });
                    ...
                    apiResponse = await  apiServices.cityInfo(cityName.text);
                    setState(() {
                      isLoading = false;
                    });
                    if(apiResponse.data.info.isNotEmpty){
