                            ...
                            child: Padding(
                              ...
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton<String>(
                                  ...
                                  items: <String>['FY 2018-19', 'FY 2019-20', 'FY 2020-21', 'FY 2021-22']
                                ...
                                child: DropdownButton<String>(
                                  ...
                                  onChanged: (String newValue) {
                                    setState(() {
                                      ...
                                      if(dropdownValue2=="Quarter 2 (Jul-Sep)"||dropdownValue2=='Quarter 3 (Oct-Dec)'
                                          ||dropdownValue2=='Quarter 4 (Jan-Mar)'){
                                        isVisible = false;
                                      }else{
                                        isVisible = true ;
                                      }
                                      ...
                                      if(dropdownValue2=="Quarter 3 (Oct-Dec)"){
                                        isVisible3 = true;
                                      }else{
                                        isVisible3 = false;

                                      }
                                      if(dropdownValue2=="Quarter 4 (Jan-Mar)"){
                                        isVisible4 = true;
                                      }else{
                                        isVisible4 = false;
                                  ...
                                  items: <String>['Quarter 1 (Apr-Jun)', 'Quarter 2 (Jul-Sep)', 'Quarter 3 (Oct-Dec)',
                                    'Quarter 4 (Jan-Mar)']
                                      .map<DropdownMenuItem<String>>((String value) {
                                    return DropdownMenuItem<String>(
                                      value: value,
                              ...
                              child: Padding(
                                ...
                                child: DropdownButtonHideUnderline(
                                  child: DropdownButton<String>(
                                    ...
                                    items: <String>['July', 'August', 'September',]
                                        .map<DropdownMenuItem<String>>((String value) {
                                      return DropdownMenuItem<String>(
                                        value: value,
                                        child: Text(value),
                              ...
                              child: Padding(
                                ...
                                child: DropdownButtonHideUnderline(
                                  child: DropdownButton<String>(
                                    ...
                                    items: <String>['October', 'November', 'December',]
                                        .map<DropdownMenuItem<String>>((String value) {
                                      return DropdownMenuItem<String>(
                                        value: value,
                                        child: Text(value),
                      ...
                      child: GFButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const ReturnDashboard()));
                        },
                        text: "Search",),
                    ),
                  ),
